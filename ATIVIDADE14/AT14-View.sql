...
SELECT nome_cliente, email_cliente,telefone_cliente,cidade 
FROM tb_cliente ; 
SELECT * FROM vw_cliente_detalhes ;

/*ATIVIDADE 2 */ 
CREATE VIEW vw_produtos_estoque as 
SELECT nome_produto,categoria,estoque
FROM tb_produto 
WHERE estoque > 100 ; 
SELECT * FROM vw_produtos_estoque ;

/*ATIVIDADE 3 */ 
CREATE VIEW vw_clientes_nascimento as
SELECT nome_cliente,data_nascimento 
FROM tb_cliente; 
SELECT * FROM vw_clientes_nascimento;

/*ATIVIDADE 4 */
CREATE VIEW vw_produtos_precos as 
SELECT nome_produto ,
