...
SELECT PrimeiroNome, CPF, Salario 
FROM Funcionarios 
...
SELECT COUNT(*) AS NumFuncionarios
FROM Funcionarios
WHERE Salario <> 3800.00 ; 
...
SELECT Sum(salario) AS SumSalarios 
From Funcionarios 
...
-- 12. Selecione o número de funcionários que têm "Almeida" como parte do nome OU têm salário inferior a 3500.
SELECT COUNT(*) As Funcionarios 
FROM Funcionarios
WHERE SegundoNome = "Almeida" or UltimoNome = "Almeida" or Salario > 3500.00;
